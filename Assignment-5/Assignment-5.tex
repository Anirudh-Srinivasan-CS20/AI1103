...
\begin{lstlisting}
https://github.com/Anirudh-Srinivasan-CS20/AI1103/blob/main/Assignment-5/Assignment-5.tex
\end{lstlisting}
\section*{Question}
...
Var [Y] &= E[Y^2] -[E(Y)]^2\text{  (definition)  }\\
        ...
        &=E[E(Y^2 | X )] - (E[E(Y | X)])^2 \nonumber\\                      &-E([E(Y | X)]^2) + E([E(Y | X)]^2)\\
        &=E[E(Y^2 | X )] - E([E(Y | X)]^2) \nonumber\\ &+ E([E(Y | X)]^2) - (E[E(Y | X)])^2\text{  (LE {\&} LIE)  }\\
