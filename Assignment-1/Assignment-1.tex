...
2                      & $\frac{1}{6}$                   \\ \hline
\end{tabular}
\caption*{\label{tab:Table 5.10}Table 5.10: This table shows probability associated with each value that the random variable X can take.}
\end{table}
\includegraphics[width=0.85\columnwidth]{Figure-1.png}
The mean of the numbers obtained on throwing
