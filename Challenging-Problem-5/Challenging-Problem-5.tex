...
\end{multline}
The condition $X_1>X_2$ on $X_4>X_1>X_3$ restricts the possibility of $X_2>X_4$ and only allows $X_4>X_2$ (as $(X_4>X_1) \cap (X_1>X_2) \implies X_4>X_2$) . Hence,
\begin{multline}
...
\end{multline}
The condition $X_1>X_2$ on $X_4>X_3>X_1$ restricts the possibility of $X_2>X_4$ and $X_2>X_3$  and only allows $X_4>X_2$ and $X_3>X_2$ (as $(X_4>X_1) \cap (X_1>X_2) \implies X_4>X_2$ and $(X_3>X_1) \cap (X_1>X_2) \implies X_3>X_2$ ) . Hence,
\begin{multline}
