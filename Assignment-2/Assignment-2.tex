...
&= 0.36787944117
\end{align}
The probability that the lifetime of an exponentially distributed random variable exceeds the expected lifetime = $\frac{1}{e}$, irrespective of the parameter $\lambda$.
Therefore, for $\lambda$ = 2, 
\begin{align}
\pr{X > 0.5} = 0.36787944117 \approx 0.37
\end{align}
\bigskip
